...
### Epic A — Schema & Validation · DSS §5, §6.3
| #    | Title | Priority | Scope | Status |
|------|-------|----------|-------|--------|
| [0002](0002-define-log-schema.md) | Define a log schema of typed fields | Must | now | Draft |
| [0003](0003-require-timestamp-and-identifier.md) | Require timestamp + ≥1 identifying field | Must | now | Draft |
| [0004](0004-disposition-mandatory-per-field.md) | Every field must declare a disposition | Must | now | Draft |
